...
INSTALLED_APPS = [
    'account.apps.AccountConfig',  # по умолчанию будут использоваться конкретно-прикладные шаблоны аутентификации
...
SOCIAL_AUTH_FACEBOOK_KEY = config.db.SOCIAL_AUTH_FACEBOOK_KEY
SOCIAL_AUTH_FACEBOOK_SECRET = config.db.SOCIAL_AUTH_FACEBOOK_SECRET
SOCIAL_AUTH_FACEBOOK_SCOPE = ['email']

SOCIAL_AUTH_TWITTER_KEY = config.db.SOCIAL_AUTH_TWITTER_KEY
SOCIAL_AUTH_TWITTER_SECRET = config.db.SOCIAL_AUTH_TWITTER_SECRET

SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = config.db.SOCIAL_AUTH_GOOGLE_OAUTH2_KEY
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = config.db.SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET
